...
Tired of seeing item names only in your current game language? The **More More Lang** solves this by injecting the names of items, blocks, and fluids from any language you choose directly into their tooltips.

This mod is essential for players who frequently interact with multi-lingual communities, share screenshots, or simply want to know the "standard" name used in another language (like English, even if they play in Japanese).
...
You need to provide a list of ISO language codes (e.g., `en_us`, `ja_jp`, `zh_cn`, `fr_fr`).
